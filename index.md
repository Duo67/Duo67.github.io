...
## 2023
  ...
  * [__IEEE MEDAI__] Muran Zhu, Xiaotong Huo, Zuozhen Zhang, __Jinduo Liu*__, Junzhong Ji*. "Dynamic Effective Connectivity Learning based on non-Parametric State Estimation and GAN". _IEEE Transactions on Instrumentation and Measurement_, 2023.
  * [__IEEE MEDAI__] Muran Zhu, Xiaotong Huo, Zuozhen Zhang, __Jinduo Liu*__, Junzhong Ji*. "Arrhythmia Detection from Electrocardiogram SignalData based on Wavelet Transform and Deep Reinforcement Learning". _IEEE International Conference on Medical Aftifical Intelligence_, 2023. (__Best Student Paper Runner-Up__)
